...
// to TYPO3 v14.3, which will use `extra.typo3/cms.Package.providesPackages` from the `composer.json`
...
if (!class_exists(\WsdlToPhp\PackageBase\AbstractSoapClientBase::class)) {
    require Environment::getExtensionsPath() . '/his_connector/contrib/Libraries/autoload.php';
}
