...
/**
 * @template-implements \Iterator<non-negative-int, PhoneNumber>
 */
final class PhoneNumberCollectionIterator implements \Iterator
{
    /**
    ...
    public function __construct(PhoneNumberCollection $collection)
    {
