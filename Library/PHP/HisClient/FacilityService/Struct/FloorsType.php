...
/**
 * This class stands for floorsType Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class FloorsType extends AbstractStructBase
{
    /**
     * The id
    ...
    /**
     * Constructor method for floorsType
     * @uses FloorsType::setId()
     * @param int[] $id
     */
    ...
    public static function validateIdForArrayConstraintFromSetId(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $floorsTypeIdItem) {
            // validation for constraint: itemType
            if (!(is_int($floorsTypeIdItem) || ctype_digit($floorsTypeIdItem))) {
                $invalidValues[] = is_object($floorsTypeIdItem) ? get_class($floorsTypeIdItem) : sprintf('%s(%s)', gettype($floorsTypeIdItem), var_export($floorsTypeIdItem, true));
            }
        }
