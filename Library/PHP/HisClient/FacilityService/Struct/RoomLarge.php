...
/**
 * This class stands for RoomLarge Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class RoomLarge extends Room
{
    /**
     * The frequencyofuse
    ...
    /**
     * Constructor method for RoomLarge
     * @uses RoomLarge::setFrequencyofuse()
     * @uses RoomLarge::setInventorynumber()
     * @uses RoomLarge::setOrgunitId()
     * @uses RoomLarge::setBuildingDefaulttext()
     * @uses RoomLarge::setCampusDefaulttext()
     * @uses RoomLarge::setBuildingId()
     * @uses RoomLarge::setPlannedDates()
     * @uses RoomLarge::setRoomCompositions()
     * @uses RoomLarge::setRoomSegments()
     * @uses RoomLarge::setEquipmentQuantity()
     ...
     * @param int $frequencyofuse
     * @return \FGTCLB\HisClient\FacilityService\Struct\RoomLarge
     */
