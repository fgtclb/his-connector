...
/**
 * This class stands for campusType Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class CampusType extends AbstractStructBase
{
    /**
     * The id
    ...
    /**
     * Constructor method for campusType
     * @uses CampusType::setId()
     * @param int[] $id
     */
    ...
    public static function validateIdForArrayConstraintFromSetId(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $campusTypeIdItem) {
            // validation for constraint: itemType
            if (!(is_int($campusTypeIdItem) || ctype_digit($campusTypeIdItem))) {
                $invalidValues[] = is_object($campusTypeIdItem) ? get_class($campusTypeIdItem) : sprintf('%s(%s)', gettype($campusTypeIdItem), var_export($campusTypeIdItem, true));
            }
        }
