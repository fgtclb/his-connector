...
/**
 * This class stands for setPrimaryOrgunitToRoomResponse Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SetPrimaryOrgunitToRoomResponse extends AbstractStructBase
{
    /**
     * The isAssigned
     * @var bool
    ...
    /**
     * Constructor method for setPrimaryOrgunitToRoomResponse
     * @uses SetPrimaryOrgunitToRoomResponse::setIsAssigned()
     ...
     * @param bool $isAssigned
     * @return \FGTCLB\HisClient\FacilityService\Struct\SetPrimaryOrgunitToRoomResponse
     */
