...
/**
 * This class stands for setPrimaryOrgunitToRoom Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SetPrimaryOrgunitToRoom extends AbstractStructBase
{
    /**
     * The roomId
     * @var int
    ...
    /**
     * Constructor method for setPrimaryOrgunitToRoom
     * @uses SetPrimaryOrgunitToRoom::setRoomId()
     * @uses SetPrimaryOrgunitToRoom::setOrgunitLid()
     * @param int $roomId
     ...
     * Set roomId value
     * @param int $roomId
     * @return \FGTCLB\HisClient\FacilityService\Struct\SetPrimaryOrgunitToRoom
     */
