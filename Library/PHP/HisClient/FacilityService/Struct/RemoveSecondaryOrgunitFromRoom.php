...
/**
 * This class stands for removeSecondaryOrgunitFromRoom Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class RemoveSecondaryOrgunitFromRoom extends AbstractStructBase
{
    /**
     * The roomId
     * @var int
    ...
    /**
     * Constructor method for removeSecondaryOrgunitFromRoom
     * @uses RemoveSecondaryOrgunitFromRoom::setRoomId()
     * @uses RemoveSecondaryOrgunitFromRoom::setOrgunitLid()
     * @param int $roomId
     ...
     * Set roomId value
     * @param int $roomId
     * @return \FGTCLB\HisClient\FacilityService\Struct\RemoveSecondaryOrgunitFromRoom
     */
