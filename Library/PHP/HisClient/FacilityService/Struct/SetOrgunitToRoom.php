...
/**
 * This class stands for setOrgunitToRoom Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SetOrgunitToRoom extends AbstractStructBase
{
    /**
     * The roomId
     * @var int
    ...
    /**
     * Constructor method for setOrgunitToRoom
     * @uses SetOrgunitToRoom::setRoomId()
     * @uses SetOrgunitToRoom::setOrgunitLid()
     * @param int $roomId
     ...
     * Set roomId value
     * @param int $roomId
     * @return \FGTCLB\HisClient\FacilityService\Struct\SetOrgunitToRoom
     */
