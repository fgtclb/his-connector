...
/**
 * This class stands for readMimeData Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ReadMimeData extends AbstractStructBase
{
    /**
     * The mimedataId
     * @var int
    ...
    /**
     * Constructor method for readMimeData
     * @uses ReadMimeData::setMimedataId()
     ...
     * @param int $mimedataId
     * @return \FGTCLB\HisClient\MimedataService\Struct\ReadMimeData
     */
