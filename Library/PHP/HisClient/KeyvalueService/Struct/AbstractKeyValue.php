...
/**
 * This class stands for AbstractKeyValue Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
abstract class AbstractKeyValue extends AbstractStructBase
{
    /**
     * The id
     * @var int
    ...
    /**
     * Constructor method for AbstractKeyValue
     * @uses AbstractKeyValue::setId()
     * @uses AbstractKeyValue::setObjGuid()
     * @uses AbstractKeyValue::setLid()
     * @uses AbstractKeyValue::setUniquename()
     * @uses AbstractKeyValue::setShorttext()
     * @uses AbstractKeyValue::setDefaulttext()
     * @uses AbstractKeyValue::setLongtext()
     * @uses AbstractKeyValue::setSortorder()
     * @uses AbstractKeyValue::setDefaultlanguage()
     * @uses AbstractKeyValue::setValidFrom()
     * @uses AbstractKeyValue::setValidTo()
     * @uses AbstractKeyValue::setAstat()
     * @uses AbstractKeyValue::setHiskeyId()
     * @param int $id
