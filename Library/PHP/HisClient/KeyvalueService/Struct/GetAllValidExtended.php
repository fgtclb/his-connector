...
/**
 * This class stands for getAllValidExtended Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class GetAllValidExtended extends AbstractStructBase
{
    /**
     * The valueClass
     * Meta information extracted from the WSDL
     * - documentation: Name of the value class, i.e. CountryValue
     * @var string
     */
    ...
    /**
     * Constructor method for getAllValidExtended
     * @uses GetAllValidExtended::setValueClass()
     * @uses GetAllValidExtended::setLang()
     ...
     * @param string $valueClass
     * @return \FGTCLB\HisClient\KeyvalueService\Struct\GetAllValidExtended
     */
