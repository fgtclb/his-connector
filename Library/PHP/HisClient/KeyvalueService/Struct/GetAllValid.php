...
/**
 * This class stands for getAllValid Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class GetAllValid extends AbstractStructBase
{
    /**
     * The valueClass
    ...
    /**
     * Constructor method for getAllValid
     * @uses GetAllValid::setValueClass()
     * @uses GetAllValid::setLang()
     ...
     * @param string $valueClass
     * @return \FGTCLB\HisClient\KeyvalueService\Struct\GetAllValid
     */
