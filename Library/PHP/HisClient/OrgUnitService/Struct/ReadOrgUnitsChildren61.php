...
/**
 * This class stands for readOrgUnitsChildren61 Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ReadOrgUnitsChildren61 extends AbstractStructBase
{
    /**
     * The lid
    ...
    /**
     * Constructor method for readOrgUnitsChildren61
     * @uses ReadOrgUnitsChildren61::setLid()
     * @uses ReadOrgUnitsChildren61::setDate()
     * @param int $lid
     * @param string $date
     */
     ...
     * Set lid value
     * @param int $lid
     * @return \FGTCLB\HisClient\OrgUnitService\Struct\ReadOrgUnitsChildren61
     */
