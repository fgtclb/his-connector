...
/**
 * This class stands for removeOrgunits Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class RemoveOrgunits extends AbstractStructBase
{
    /**
     * The lid
     * @var int
    ...
    protected int $lid;
    /**
     * Constructor method for removeOrgunits
     * @uses RemoveOrgunits::setLid()
     * @param int $lid
     */
     ...
     * Set lid value
     * @param int $lid
     * @return \FGTCLB\HisClient\OrgUnitService\Struct\RemoveOrgunits
     */
