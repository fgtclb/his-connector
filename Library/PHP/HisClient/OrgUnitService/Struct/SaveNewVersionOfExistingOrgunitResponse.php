...
/**
 * This class stands for saveNewVersionOfExistingOrgunitResponse Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SaveNewVersionOfExistingOrgunitResponse extends AbstractStructBase
{
    /**
     * The savedOrgunit
    ...
    /**
     * Constructor method for saveNewVersionOfExistingOrgunitResponse
     * @uses SaveNewVersionOfExistingOrgunitResponse::setSavedOrgunit()
     ...
     * @param \FGTCLB\HisClient\OrgUnitService\Struct\OrgUnit $savedOrgunit
     * @return \FGTCLB\HisClient\OrgUnitService\Struct\SaveNewVersionOfExistingOrgunitResponse
     */
