...
/**
 * This class stands for orgUnitIdsType Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class OrgUnitIdsType extends AbstractStructBase
{
    /**
     * The id
    ...
    /**
     * Constructor method for orgUnitIdsType
     * @uses OrgUnitIdsType::setId()
     * @param int[] $id
     */
    ...
    public static function validateIdForArrayConstraintFromSetId(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $orgUnitIdsTypeIdItem) {
            // validation for constraint: itemType
            if (!(is_int($orgUnitIdsTypeIdItem) || ctype_digit($orgUnitIdsTypeIdItem))) {
                $invalidValues[] = is_object($orgUnitIdsTypeIdItem) ? get_class($orgUnitIdsTypeIdItem) : sprintf('%s(%s)', gettype($orgUnitIdsTypeIdItem), var_export($orgUnitIdsTypeIdItem, true));
            }
        }
