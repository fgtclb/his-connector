...
/**
 * This class stands for getOrgunitWithChildren Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class GetOrgunitWithChildren extends AbstractStructBase
{
    /**
     * The lid
    ...
    /**
     * Constructor method for getOrgunitWithChildren
     * @uses GetOrgunitWithChildren::setLid()
     * @uses GetOrgunitWithChildren::setDate()
     * @param int $lid
     * @param string $date
     */
     ...
     * Set lid value
     * @param int $lid
     * @return \FGTCLB\HisClient\OrgUnitService\Struct\GetOrgunitWithChildren
     */
