...
/**
 * This class stands for OrgUnit Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class OrgUnit extends AbstractStructBase
{
    /**
     * The languageId
     * @var int
     ...
     * The parentId
     * Meta information extracted from the WSDL
     * - documentation: default is root node
     * - minOccurs: 0
     * - nillable: true
     * @var int|null
     */
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \FGTCLB\HisClient\OrgUnitService\Struct\ChildrenType|null
     */
    protected ?\FGTCLB\HisClient\OrgUnitService\Struct\ChildrenType $children = null;
    /**
     * Constructor method for OrgUnit
     * @uses OrgUnit::setLanguageId()
     * @uses OrgUnit::setDisplaytext()
     * @uses OrgUnit::setId()
     * @uses OrgUnit::setLid()
     * @uses OrgUnit::setShortcut()
     * @uses OrgUnit::setShorttext()
     * @uses OrgUnit::setUniquename()
     * @uses OrgUnit::setLongtext()
     * @uses OrgUnit::setParentId()
     * @uses OrgUnit::setType()
     * @uses OrgUnit::setValidFrom()
     * @uses OrgUnit::setValidTo()
     * @uses OrgUnit::setVersionedObjId()
     * @uses OrgUnit::setChildren()
     ...
     */
    public function __construct(int $languageId, string $displaytext, ?int $id = null, ?int $lid = null, ?string $shortcut = null, ?string $shorttext = null, ?string $uniquename = null, ?string $longtext = null, ?int $parentId = null, ?int $type = null, ?string $validFrom = null, ?string $validTo = null, ?int $versionedObjId = null, ?\FGTCLB\HisClient\OrgUnitService\Struct\ChildrenType $children = null)
    {
        $this
     ...
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \FGTCLB\HisClient\OrgUnitService\Struct\ChildrenType|null
     */
     ...
     * @return \FGTCLB\HisClient\OrgUnitService\Struct\OrgUnit
     */
    public function setChildren(?\FGTCLB\HisClient\OrgUnitService\Struct\ChildrenType $children = null): self
    {
