...
/**
 * This class stands for getOrgunitLidResponse Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class GetOrgunitLidResponse extends AbstractStructBase
{
    /**
     * The lid
     * @var int
    ...
    protected int $lid;
    /**
     * Constructor method for getOrgunitLidResponse
     * @uses GetOrgunitLidResponse::setLid()
     * @param int $lid
     */
     ...
     * Set lid value
     * @param int $lid
     * @return \FGTCLB\HisClient\OrgUnitService\Struct\GetOrgunitLidResponse
     */
