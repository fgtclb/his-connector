...
/**
 * This class stands for readOrgUnit Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ReadOrgUnit extends AbstractStructBase
{
    /**
     * The lid
     * @var int
    ...
    /**
     * Constructor method for readOrgUnit
     * @uses ReadOrgUnit::setLid()
     * @uses ReadOrgUnit::setDate()
     * @param int $lid
     * @param string $date
     */
     ...
     * Set lid value
     * @param int $lid
     * @return \FGTCLB\HisClient\OrgUnitService\Struct\ReadOrgUnit
     */
