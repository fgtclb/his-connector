...
/**
 * This class stands for orgunitsType Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class OrgunitsType extends AbstractStructBase
{
    /**
     * The orgunit
    ...
    /**
     * Constructor method for orgunitsType
     * @uses OrgunitsType::setOrgunit()
    ...
    public static function validateOrgunitForArrayConstraintFromSetOrgunit(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $orgunitsTypeOrgunitItem) {
            // validation for constraint: itemType
            if (!$orgunitsTypeOrgunitItem instanceof \FGTCLB\HisClient\OrgUnitService\Struct\OrgUnit) {
                $invalidValues[] = is_object($orgunitsTypeOrgunitItem) ? get_class($orgunitsTypeOrgunitItem) : sprintf('%s(%s)', gettype($orgunitsTypeOrgunitItem), var_export($orgunitsTypeOrgunitItem, true));
            }
        }
