...
/**
 * This class stands for readEAddress Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ReadEAddress extends AbstractStructBase
{
    /**
     * The addressId
     * @var int
    ...
    /**
     * Constructor method for readEAddress
     * @uses ReadEAddress::setAddressId()
     * @param int $addressId
     */
     ...
     * Set addressId value
     * @param int $addressId
     * @return \FGTCLB\HisClient\AddressService\Struct\ReadEAddress
     */
