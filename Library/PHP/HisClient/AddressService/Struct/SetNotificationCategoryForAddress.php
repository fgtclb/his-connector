...
/**
 * This class stands for setNotificationCategoryForAddress Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SetNotificationCategoryForAddress extends AbstractStructBase
{
    /**
     * The addressId
     * @var int
    ...
    /**
     * Constructor method for setNotificationCategoryForAddress
     * @uses SetNotificationCategoryForAddress::setAddressId()
     * @uses SetNotificationCategoryForAddress::setNotificationCategory()
     * @param int $addressId
     ...
     * Set addressId value
     * @param int $addressId
     * @return \FGTCLB\HisClient\AddressService\Struct\SetNotificationCategoryForAddress
     */
