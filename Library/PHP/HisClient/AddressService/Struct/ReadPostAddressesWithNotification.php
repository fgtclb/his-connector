...
/**
 * This class stands for readPostAddressesWithNotification Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ReadPostAddressesWithNotification extends AbstractStructBase
{
    /**
     * The id
     * @var int
    ...
    /**
     * Constructor method for readPostAddressesWithNotification
     * @uses ReadPostAddressesWithNotification::setId()
     * @uses ReadPostAddressesWithNotification::setObjekttype()
     * @param int $id
     ...
     * Set id value
     * @param int $id
     * @return \FGTCLB\HisClient\AddressService\Struct\ReadPostAddressesWithNotification
     */
