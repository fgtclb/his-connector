...
/**
 * This class stands for PostAddressWithNillablePostcode Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class PostAddressWithNillablePostcode extends Address
{
    /**
     * The street
     * @var string
    ...
    /**
     * Constructor method for PostAddressWithNillablePostcode
     * @uses PostAddressWithNillablePostcode::setStreet()
     * @uses PostAddressWithNillablePostcode::setCity()
     * @uses PostAddressWithNillablePostcode::setPostcode()
     * @uses PostAddressWithNillablePostcode::setAddressaddition()
     * @uses PostAddressWithNillablePostcode::setPostofficebox()
     * @uses PostAddressWithNillablePostcode::setCompany()
     * @uses PostAddressWithNillablePostcode::setState()
     * @uses PostAddressWithNillablePostcode::setCountryId()
     * @param string $street
     * @param string $city
