...
/**
 * This class stands for readEAddresses Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ReadEAddresses extends AbstractStructBase
{
    /**
     * The id
     * @var int
    ...
    /**
     * Constructor method for readEAddresses
     * @uses ReadEAddresses::setId()
     * @uses ReadEAddresses::setObjekttype()
     * @param int $id
     ...
     * Set id value
     * @param int $id
     * @return \FGTCLB\HisClient\AddressService\Struct\ReadEAddresses
     */
