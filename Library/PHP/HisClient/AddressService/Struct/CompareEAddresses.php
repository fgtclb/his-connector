...
/**
 * This class stands for compareEAddresses Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class CompareEAddresses extends AbstractStructBase
{
    /**
     * The eAddressOne
    ...
    /**
     * Constructor method for compareEAddresses
     * @uses CompareEAddresses::setEAddressOne()
     * @uses CompareEAddresses::setEAddressTwo()
     ...
     * @param \FGTCLB\HisClient\AddressService\Struct\EAddress $eAddressOne
     * @return \FGTCLB\HisClient\AddressService\Struct\CompareEAddresses
     */
