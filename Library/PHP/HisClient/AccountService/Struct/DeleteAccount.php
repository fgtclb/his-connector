...
/**
 * This class stands for deleteAccount Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class DeleteAccount extends AbstractStructBase
{
    /**
     * The accountId
     * @var int
    ...
    /**
     * Constructor method for deleteAccount
     * @uses DeleteAccount::setAccountId()
     * @param int $accountId
     */
     ...
     * Set accountId value
     * @param int $accountId
     * @return \FGTCLB\HisClient\AccountService\Struct\DeleteAccount
     */
