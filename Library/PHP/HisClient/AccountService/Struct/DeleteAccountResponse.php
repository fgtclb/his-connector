...
/**
 * This class stands for deleteAccountResponse Struct
 * @subpackage Structs
 */
...
class DeleteAccountResponse extends AbstractStructBase
{
     ...
     * @uses DeleteAccountResponse::setDeleted()
     * @param bool $deleted
     */
     ...
     * Set deleted value
     * @param bool $deleted
     * @return \FGTCLB\HisClient\AccountService\Struct\DeleteAccountResponse
     */
