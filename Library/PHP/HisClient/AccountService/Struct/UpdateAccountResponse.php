...
/**
 * This class stands for updateAccountResponse Struct
 * @subpackage Structs
 */
...
class UpdateAccountResponse extends AbstractStructBase
{
     ...
     * @uses UpdateAccountResponse::setAccountId()
     * @param int $accountId
     */
     ...
     * Set accountId value
     * @param int $accountId
     * @return \FGTCLB\HisClient\AccountService\Struct\UpdateAccountResponse
     */
