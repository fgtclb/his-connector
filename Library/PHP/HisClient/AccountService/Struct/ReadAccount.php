...
/**
 * This class stands for readAccount Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ReadAccount extends AbstractStructBase
{
    /**
     * The accountId
     * @var int
    ...
    /**
     * Constructor method for readAccount
     * @uses ReadAccount::setAccountId()
     * @param int $accountId
     */
     ...
     * Set accountId value
     * @param int $accountId
     * @return \FGTCLB\HisClient\AccountService\Struct\ReadAccount
     */
