 ...
 * - documentation: Sets the location of the affiliation to given postaddress. Any previous assignment is removed. In case a postaddress was assigned before, the old address will be deleted if it has no other references.
 * @subpackage Structs
 */
...
class PostAddress extends Address
{
     ...
     * @param int $countryId
     */
    public function __construct(string $postcode, string $street, string $city, ?string $addressaddition = null, ?string $postofficebox = null, ?string $company = null, ?string $state = null, ?int $countryId = null)
    {
        $this
