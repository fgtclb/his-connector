...
/**
 * This class stands for updateAffiliationResponse Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class UpdateAffiliationResponse extends AbstractStructBase
{
    /**
     * The affiliation
    ...
    /**
     * Constructor method for updateAffiliationResponse
     * @uses UpdateAffiliationResponse::setAffiliation()
     ...
     * @param \FGTCLB\HisClient\PersonOrgunitService\Struct\Affiliation $affiliation
     * @return \FGTCLB\HisClient\PersonOrgunitService\Struct\UpdateAffiliationResponse
     */
