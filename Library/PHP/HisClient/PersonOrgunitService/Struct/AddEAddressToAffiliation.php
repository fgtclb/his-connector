...
/**
 * This class stands for addEAddressToAffiliation Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class AddEAddressToAffiliation extends AbstractStructBase
{
    /**
     * The personOrgunitId
     * @var int
    ...
    /**
     * Constructor method for addEAddressToAffiliation
     * @uses AddEAddressToAffiliation::setPersonOrgunitId()
     * @uses AddEAddressToAffiliation::setAddressId()
     ...
     * @param int $personOrgunitId
     * @return \FGTCLB\HisClient\PersonOrgunitService\Struct\AddEAddressToAffiliation
     */
