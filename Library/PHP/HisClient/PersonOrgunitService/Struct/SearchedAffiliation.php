...
/**
 * This class stands for SearchedAffiliation Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SearchedAffiliation extends AbstractStructBase
{
    /**
     * The id
    ...
    /**
     * Constructor method for SearchedAffiliation
     * @uses SearchedAffiliation::setId()
     * @uses SearchedAffiliation::setPersonId()
     * @uses SearchedAffiliation::setOrgunitLid()
     * @uses SearchedAffiliation::setAffiliationTypeId()
     * @uses SearchedAffiliation::setValidFrom()
     * @uses SearchedAffiliation::setValidTo()
     * @param int $id
     * @param int $personId
     ...
     */
    public function __construct(int $id, int $personId, int $orgunitLid, int $affiliationTypeId, string $validFrom, string $validTo)
    {
        $this
            ->setId($id)
