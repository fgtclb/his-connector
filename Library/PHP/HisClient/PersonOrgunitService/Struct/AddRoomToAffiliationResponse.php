...
/**
 * This class stands for addRoomToAffiliationResponse Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class AddRoomToAffiliationResponse extends AbstractStructBase
{
    /**
     * The locationId
     * @var int
    ...
    /**
     * Constructor method for addRoomToAffiliationResponse
     * @uses AddRoomToAffiliationResponse::setLocationId()
     ...
     * @param int $locationId
     * @return \FGTCLB\HisClient\PersonOrgunitService\Struct\AddRoomToAffiliationResponse
     */
