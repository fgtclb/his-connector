...
/**
 * This class stands for deletePersonAttributeFromPerson Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class DeletePersonAttributeFromPerson extends AbstractStructBase
{
    /**
     * The personId
     * @var int
    ...
    /**
     * Constructor method for deletePersonAttributeFromPerson
     * @uses DeletePersonAttributeFromPerson::setPersonId()
     * @uses DeletePersonAttributeFromPerson::setPersonAttributeId()
     * @param int $personId
     ...
     * Set personId value
     * @param int $personId
     * @return \FGTCLB\HisClient\PersonService\Struct\DeletePersonAttributeFromPerson
     */
