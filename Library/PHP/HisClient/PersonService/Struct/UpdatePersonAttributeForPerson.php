...
/**
 * This class stands for updatePersonAttributeForPerson Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class UpdatePersonAttributeForPerson extends AbstractStructBase
{
    /**
     * The personId
     * @var int
    ...
    /**
     * Constructor method for updatePersonAttributeForPerson
     * @uses UpdatePersonAttributeForPerson::setPersonId()
     * @uses UpdatePersonAttributeForPerson::setPersonAttributeDto()
     * @param int $personId
     ...
     * Set personId value
     * @param int $personId
     * @return \FGTCLB\HisClient\PersonService\Struct\UpdatePersonAttributeForPerson
     */
