...
/**
 * This class stands for deleteAddress Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class DeleteAddress extends AbstractStructBase
{
    /**
     * The addressId
     * @var int
    ...
    /**
     * Constructor method for deleteAddress
     * @uses DeleteAddress::setAddressId()
     * @param int $addressId
     */
     ...
     * Set addressId value
     * @param int $addressId
     * @return \FGTCLB\HisClient\PersonAddressService\Struct\DeleteAddress
     */
