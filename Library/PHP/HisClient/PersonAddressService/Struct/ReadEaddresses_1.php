...
class ReadEaddresses_1 extends AbstractStructBase
{
    /**
     * The personId
     * @var int
     ...
     * @uses ReadEaddresses_1::setPersonId()
     * @param int $personId
     */
     ...
     * Set personId value
     * @param int $personId
     * @return \FGTCLB\HisClient\PersonAddressService\Struct\ReadEaddresses_1
     */
