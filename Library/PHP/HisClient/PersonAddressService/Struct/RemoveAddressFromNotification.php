...
/**
 * This class stands for removeAddressFromNotification Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class RemoveAddressFromNotification extends AbstractStructBase
{
    /**
     * The addressId
     * @var int
    ...
    /**
     * Constructor method for removeAddressFromNotification
     * @uses RemoveAddressFromNotification::setAddressId()
     * @uses RemoveAddressFromNotification::setNotificationCategory()
     * @param int $addressId
     ...
     * Set addressId value
     * @param int $addressId
     * @return \FGTCLB\HisClient\PersonAddressService\Struct\RemoveAddressFromNotification
     */
