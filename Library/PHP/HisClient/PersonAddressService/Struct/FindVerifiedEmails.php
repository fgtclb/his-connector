...
/**
 * This class stands for findVerifiedEmails Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class FindVerifiedEmails extends AbstractStructBase
{
    /**
     * The id
    ...
    /**
     * Constructor method for findVerifiedEmails
     * @uses FindVerifiedEmails::setId()
     * @uses FindVerifiedEmails::setPersonId()
     * @uses FindVerifiedEmails::setNotificationCategory()
     * @uses FindVerifiedEmails::setValidTo()
     * @uses FindVerifiedEmails::setEaddressValue()
     * @uses FindVerifiedEmails::setAddresstag()
     * @param string $id
     ...
     * @param string $id
     * @return \FGTCLB\HisClient\PersonAddressService\Struct\FindVerifiedEmails
     */
