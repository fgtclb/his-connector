...
/**
 * This class stands for createPostaddress Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class CreatePostaddress extends AbstractStructBase
{
    /**
     * The personId
    ...
    /**
     * Constructor method for createPostaddress
     * @uses CreatePostaddress::setPersonId()
     * @uses CreatePostaddress::setNotificationCategory()
     * @uses CreatePostaddress::setPostaddress()
     * @param int $personId
     * @param string $notificationCategory
     * @param \FGTCLB\HisClient\PersonAddressService\Struct\Postaddress_1 $postaddress
     */
    public function __construct(int $personId, string $notificationCategory, \FGTCLB\HisClient\PersonAddressService\Struct\Postaddress_1 $postaddress)
    {
        $this
     ...
     * Set personId value
     * @param int $personId
     * @return \FGTCLB\HisClient\PersonAddressService\Struct\CreatePostaddress
     */
