...
/**
 * This class stands for PersonAddressesByNotification Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class PersonAddressesByNotification extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for PersonAddressesByNotification
     * @uses PersonAddressesByNotification::setNotificationCategory()
     * @uses PersonAddressesByNotification::setPostaddresses()
     * @uses PersonAddressesByNotification::setEmails()
     * @uses PersonAddressesByNotification::setPhones()
     * @uses PersonAddressesByNotification::setMessengers()
     * @uses PersonAddressesByNotification::setHyperlinks()
