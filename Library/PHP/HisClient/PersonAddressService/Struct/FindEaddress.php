...
/**
 * This class stands for findEaddress Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class FindEaddress extends AbstractStructBase
{
    /**
     * The id
     ...
     * The eaddresstype
     * Meta information extracted from the WSDL
     * - documentation: Type of an electric address as Uniquename
     * - minOccurs: 0
     * - nillable: true
     * @var string|null
     */
    ...
    /**
     * Constructor method for findEaddress
     * @uses FindEaddress::setId()
     * @uses FindEaddress::setPersonId()
     * @uses FindEaddress::setNotificationCategory()
     * @uses FindEaddress::setValidTo()
     * @uses FindEaddress::setEaddressValue()
     * @uses FindEaddress::setEaddresstype()
     * @uses FindEaddress::setAddresstag()
     * @param string $id
     ...
     */
    public function __construct(?string $id = null, ?string $personId = null, ?string $notificationCategory = null, ?string $validTo = null, ?string $eaddressValue = null, ?string $eaddresstype = null, ?string $addresstag = null)
    {
        $this
            ->setId($id)
     ...
     * @param string $id
     * @return \FGTCLB\HisClient\PersonAddressService\Struct\FindEaddress
     */
