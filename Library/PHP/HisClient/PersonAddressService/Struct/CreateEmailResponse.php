...
/**
 * This class stands for createEmailResponse Struct
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class CreateEmailResponse extends AbstractStructBase
{
    /**
     * The addressId
    ...
    /**
     * Constructor method for createEmailResponse
     * @uses CreateEmailResponse::setAddressId()
     * @param int $addressId
     */
     ...
     * Set addressId value
     * @param int $addressId
     * @return \FGTCLB\HisClient\PersonAddressService\Struct\CreateEmailResponse
     */
