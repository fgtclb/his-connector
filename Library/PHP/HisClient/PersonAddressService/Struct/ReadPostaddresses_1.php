...
class ReadPostaddresses_1 extends AbstractStructBase
{
    /**
     * The personId
     * @var int
     ...
     * @uses ReadPostaddresses_1::setPersonId()
     * @param int $personId
     */
     ...
     * Set personId value
     * @param int $personId
     * @return \FGTCLB\HisClient\PersonAddressService\Struct\ReadPostaddresses_1
     */
