...
**Product:** FGTCLB: HIS Connector
**Reference:** DoC-his_connector-1.0.0

## 1. Product identification

- **Product name:** FGTCLB: HIS Connector
- **Type:** TYPO3 Extension
- **Extension key / package:** his_connector (fgtclb/his-connector)
- **Version:** 1.0.0 (initial issuance of this declaration)
- **Valid for:** version 1.0.0 and subsequent releases, until superseded by a new declaration issued for a later substantial modification (Art. 3(30) CRA)
- **Distribution channel:** Private Composer Repository — https://github.com/fgtclb/his-connector/releases
...
FGTCLB: HIS Connector, version 1.0.0, as distributed via a private
Composer repository.
